...
/*
  ---------------------------------------------------------
  | Ubicaciones.class.skel    Skeleton for main clases        |
  |---------------------------------------------------------|
...
class Ubicaciones {
    ...
    private  $items = [array("column_name"=>"ubic_nombre","nullable"=>"NO","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Ubic Nombre=>","titulo_listado"=>"Ubic Nombre","type"=>"text","required"=>"required","inline"=>"false","editable"=>"readonly","insert"=>"Yes","default"=>"","pk"=>"PRI","extra"=>""),
 array("column_name"=>"suc","nullable"=>"NO","data_type"=>"varchar","max_length"=>"10","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Suc=>","titulo_listado"=>"Suc","type"=>"text","required"=>"required","inline"=>"false","editable"=>"No","insert"=>"Yes","default"=>"","pk"=>"PRI","extra"=>""),
 array("column_name"=>"tipo","nullable"=>"NO","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Tipo=>","titulo_listado"=>"Tipo","type"=>"select","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"Estante=>Estante,Sector=>Sector","pk"=>"","extra"=>""),
 array("column_name"=>"filas","nullable"=>"NO","data_type"=>"int","max_length"=>"","numeric_pres"=>"10","dec"=>"0","titulo_campo"=>"Filas=>","titulo_listado"=>"Filas","type"=>"number","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),
 array("column_name"=>"cols","nullable"=>"NO","data_type"=>"int","max_length"=>"","numeric_pres"=>"10","dec"=>"0","titulo_campo"=>"Cols=>","titulo_listado"=>"Cols","type"=>"number","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),
 array("column_name"=>"sentido","nullable"=>"YES","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Sentido=>","titulo_listado"=>"Sentido","type"=>"select","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"Normal=>Normal,Invertido=>Invertido","pk"=>"","extra"=>"")];    
    private $primary_key = 'ubic_nombre';
    private $limit = 100;
    ...
    function main() {
        ...
        $t = new Y_Template("Ubicaciones.html");
        $t->Show("headers");
