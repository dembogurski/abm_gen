...
/*
  ---------------------------------------------------------
  | Ventas.class.skel    Skeleton for main clases        |
  |---------------------------------------------------------|
...
class Ventas {
    ...
    private  $items = [array("column_name"=>"id_cupon","nullable"=>"NO","data_type"=>"int","max_length"=>"","numeric_pres"=>"10","dec"=>"0","titulo_campo"=>"Id Cupon=>","titulo_listado"=>"Id Cupon","type"=>"number","required"=>"required","inline"=>"false","editable"=>"readonly","insert"=>"No","default"=>"","pk"=>"PRI","extra"=>"auto_increment"),
 array("column_name"=>"usuario","nullable"=>"NO","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Usuario=>","titulo_listado"=>"Usuario","type"=>"text","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"MUL","extra"=>""),
 array("column_name"=>"fecha","nullable"=>"YES","data_type"=>"date","max_length"=>"","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Fecha=>","titulo_listado"=>"Fecha","type"=>"date","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"No","default"=>"","pk"=>"","extra"=>""),
 array("column_name"=>"codigo","nullable"=>"YES","data_type"=>"varchar","max_length"=>"12","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Codigo=>","titulo_listado"=>"Codigo","type"=>"text","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),
 array("column_name"=>"tipo","nullable"=>"YES","data_type"=>"varchar","max_length"=>"10","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Tipo=>","titulo_listado"=>"Tipo","type"=>"select","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"valor_fijo=>Valor Fijo,porcentaje=>Porcentaje","pk"=>"","extra"=>""),
 array("column_name"=>"valor","nullable"=>"YES","data_type"=>"decimal","max_length"=>"","numeric_pres"=>"16","dec"=>"0","titulo_campo"=>"Valor=>","titulo_listado"=>"Valor","type"=>"number","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),
 array("column_name"=>"vencimiento","nullable"=>"YES","data_type"=>"date","max_length"=>"","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Vencimiento=>","titulo_listado"=>"Vencimiento","type"=>"date","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),
 array("column_name"=>"estado","nullable"=>"YES","data_type"=>"varchar","max_length"=>"10","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Estado=>","titulo_listado"=>"Estado","type"=>"select","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"Activo=>Activo,Vencido=>Vencido,Utilizado=>Utilizado","pk"=>"","extra"=>"")];    
    private $primary_key = 'id_cupon';
    private $limit = 100;
