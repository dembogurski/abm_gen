...
class Pdvs {
    ...
    private $table = 'pdvs';
    private  $items = [array("column_name"=>"pdv_cod","nullable"=>"NO","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Codigo Punto Exp=>","titulo_listado"=>"Codigo Punto Exp","type"=>"text","required"=>"required","inline"=>"false","editable"=>"readonly","insert"=>"Yes","default"=>"","pk"=>"PRI","extra"=>""),
 array("column_name"=>"suc","nullable"=>"NO","data_type"=>"varchar","max_length"=>"10","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Suc=>","titulo_listado"=>"Suc","type"=>"text","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"PRI","extra"=>""),
 array("column_name"=>"pdv_ubic","nullable"=>"NO","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Tipo Doc=>","titulo_listado"=>"Tipo Doc","type"=>"select","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"Factura=>Factura,Nota de Credito=>Nota de Credito,Recibo=>Recibo,Factura Conformada=>Factura Conformada","pk"=>"PRI","extra"=>""),
 array("column_name"=>"tipo","nullable"=>"NO","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Tipo=>","titulo_listado"=>"Tipo","type"=>"text","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"PRI","extra"=>""),
 array("column_name"=>"moneda","nullable"=>"NO","data_type"=>"varchar","max_length"=>"4","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Moneda=>","titulo_listado"=>"Moneda","type"=>"select","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"G$=>G$,U$=>U$","pk"=>"PRI","extra"=>""),
 array("column_name"=>"timbrado","nullable"=>"YES","data_type"=>"varchar","max_length"=>"8","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Timbrado=>","titulo_listado"=>"Timbrado","type"=>"text","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),
 array("column_name"=>"serie","nullable"=>"YES","data_type"=>"int","max_length"=>"","numeric_pres"=>"10","dec"=>"0","titulo_campo"=>"Nro Doc=>","titulo_listado"=>"Nro Doc","type"=>"number","required"=>"required","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"0","pk"=>"","extra"=>"")];    
