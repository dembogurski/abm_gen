...
class Ubicaciones {
 ...
 array("column_name"=>"sentido","nullable"=>"YES","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Sentido=>","titulo_listado"=>"Sentido","type"=>"text","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"Normal=>Normal,Invertido=>Invertido","pk"=>"","extra"=>"")];    
