...
/*
  ---------------------------------------------------------
  | Comisiones_mayoristas.class.skel    Skeleton for main clases        |
  |---------------------------------------------------------|
 ...
 * @author Doglas
 */
class Comisiones_mayoristas {

    private $table = 'comisiones_mayoristas';
    private  $items = [array("column_name"=>"codigo","nullable"=>"NO","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Codigo=>","titulo_listado"=>"Codigo","type"=>"db_select","required"=>"required","inline"=>"false","editable"=>"readonly","insert"=>"Yes","default"=>"articulos=>codigo,descrip","pk"=>"PRI","extra"=>""),
 array("column_name"=>"um_cod","nullable"=>"NO","data_type"=>"varchar","max_length"=>"10","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Um Cod=>","titulo_listado"=>"Um Cod","type"=>"db_select","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"unidades_medida=>um_cod,um_descri","pk"=>"PRI","extra"=>""),
 array("column_name"=>"fecha","nullable"=>"NO","data_type"=>"date","max_length"=>"","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Fecha=>","titulo_listado"=>"Fecha","type"=>"date","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"PRI","extra"=>""),
 array("column_name"=>"precio","nullable"=>"NO","data_type"=>"decimal","max_length"=>"","numeric_pres"=>"16","dec"=>"2","titulo_campo"=>"Precio=>","titulo_listado"=>"Precio","type"=>"number","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>"")];    
    ...
    function main() {
        ...
        $t = new Y_Template("Comisiones_mayoristas.html");
        $t->Show("headers");
