...
/*
  ---------------------------------------------------------
  | Unidades_medida.class.skel    Skeleton for main clases        |
  |---------------------------------------------------------|
...
class Unidades_medida {
    ...
    private  $items = [array("column_name"=>"um_cod","nullable"=>"NO","data_type"=>"varchar","max_length"=>"10","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Um Cod=>","titulo_listado"=>"Um Cod","type"=>"text","required"=>"required","inline"=>"false","editable"=>"readonly","insert"=>"Yes","default"=>"","pk"=>"PRI","extra"=>""),
 array("column_name"=>"um_descri","nullable"=>"YES","data_type"=>"varchar","max_length"=>"30","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Um Descri=>","titulo_listado"=>"Um Descri","type"=>"text","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),
 array("column_name"=>"um_ref","nullable"=>"YES","data_type"=>"varchar","max_length"=>"4","numeric_pres"=>"","dec"=>"","titulo_campo"=>"Um Ref=>","titulo_listado"=>"Um Ref","type"=>"db_select","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"unidades_medida=>um_cod,um_desci","pk"=>"","extra"=>""),
 array("column_name"=>"um_mult","nullable"=>"YES","data_type"=>"decimal","max_length"=>"","numeric_pres"=>"16","dec"=>"2","titulo_campo"=>"Um Mult=>","titulo_listado"=>"Um Mult","type"=>"number","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>""),
 array("column_name"=>"um_prior","nullable"=>"YES","data_type"=>"int","max_length"=>"","numeric_pres"=>"10","dec"=>"0","titulo_campo"=>"Um Prior=>","titulo_listado"=>"","type"=>"number","required"=>"","inline"=>"false","editable"=>"Yes","insert"=>"Yes","default"=>"","pk"=>"","extra"=>"")];    
    ...
    function main() {
        ...
        $t = new Y_Template("Unidades_medida.html");
        $t->Show("headers");
